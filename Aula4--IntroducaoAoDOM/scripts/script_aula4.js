...
//Exibindo a estrutura completa da página e todos seus elementos
console.log(document)

//Informações do body
console.log(document.body)

//BODY -> Pegando a coleção de LI do UL
...
let elemento2 = document.querySelector('contenido'); //Erro pq precisa do ponto na classe
